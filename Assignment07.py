...
#   ACook,3/11/2026,Created Script
# ------------------------------------------------------------------------------------------ #
import json
...
class Person:
    """
        A collection of functions relating to person data

        ChangeLog: (Who, When, What)
        ACook,3.11.2026,Created Class
        """
...
class Student(Person):
    """
            A collection of functions relating to students,
...
# TODO add the setter for course_name (Done)
    ...
    def course_name(self, value: str):
        try:  # using a try block to capture when an input cannot be changed to a float
            ...
            raise ValueError("The course name you entered is invalid.")
    ...
    def read_data_from_file(file_name: str):
        ...
        try:
            ...
            for student in json_students:
                student_data: Student = Student(first_name=student["FirstName"],
                                                last_name= student["LastName"],
                                                course_name=student["CourseName"])
                student_objects.append(student_data)
            file.close()
    ...
    def write_data_to_file(file_name: str, student_data: list):
        ...
        try:
            ...
            for student in student_data:
                students = {"FirstName": student.first_name,
                            "LastName": student.last_name,
                            "CourseName": student.course_name}
                json_students.append(students)
...
class IO:
    ...
    def input_student_data(student_data: list):
        ...
        try:
            ...
            # TODO Replace this code to use a Student objects instead of a dictionary object (Done)
